...
<div class="row">
    <div class="col-md-12">
        <a href="<?= base_url('dosen/forum?kelas_id=' . $topik['kelas_id']) ?>" class="btn btn-outline-secondary mb-3">
        ...
        <?php if (empty($balasan)): ?>
            <div class="alert alert-light text-center py-4 mb-4 border rounded">
                Belum ada tanggapan untuk diskusi ini. Jadilah yang pertama memberikan respon!
            </div>
        <?php else: ?>
        ...
        <div class="card card-outline card-warning mt-4">
            ...
            <form action="<?= base_url('dosen/forum/reply/' . $topik['id']) ?>" method="post">
                <div class="card-body">
