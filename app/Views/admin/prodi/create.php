        ...
        <form action="<?= base_url('admin/prodi/store') ?>" method="post">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kode" name="kode" value="<?= old('kode') ?>" placeholder="Contoh: TI, SI, KEP" required>
                </div>
                <div class="form-group">
                    <label for="nama_prodi">Nama Program Studi</label>
                    <input type="text" class="form-control" id="nama_prodi" name="nama_prodi" value="<?= old('nama_prodi') ?>" placeholder="Contoh: S1 Teknik Informatika" required>
                </div>
            </div>
