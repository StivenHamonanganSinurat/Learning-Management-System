        ...
        <form action="<?= base_url('admin/kelas/update/'.$kelas['id']) ?>" method="post">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="mata_kuliah_id" name="mata_kuliah_id" required>
                        ...
                        <?php foreach($matakuliah as $mk): ?>
                            <option value="<?= $mk['id'] ?>" <?= old('mata_kuliah_id', $kelas['mata_kuliah_id']) == $mk['id'] ? 'selected' : '' ?>><?= $mk['kode_mk'] ?> - <?= $mk['nama'] ?> (<?= $mk['nama_dosen'] ?>)</option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tahun_ajaran" name="tahun_ajaran" value="<?= old('tahun_ajaran', $kelas['tahun_ajaran']) ?>" required>
                </div>
